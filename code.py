...
def total_costs(topic_name, year_name, group_type):
    
    #os.chdir("/Users/anavudragovic/Dropbox/Cosmos4HE")
    
    # choose directory where the files and grpahs produced in this function will be stored
    folder_name = "total_costs"
    path_name = "C:\\Users\\milan\\Dropbox\\Cosmos4HE\\milan\\02_plots\\" + folder_name
    ...
    if group_type == "coordination":
        if topic_name=="ALL":
            ...
            plt.savefig("total_costs_all_calls.png", dpi=300)
        else:
            ...
            plt.legend(handles, labels)
            plt.savefig("total_costs_"+topic_name+year_name+".png", dpi=300)
        ...
        if topic_name=="ALL":
            ...
            plt.legend(handles, labels)
            plt.savefig("total_costs_groups_all_calls.png", dpi=300)
        else:
            # use topic_name and year_name from the function arguments
            ...
            data_topic = pd.read_sql(sql, conn)
            plt.figure(figsize=(14,6))
            colors = {'EU14':'tab:blue', 'EU13':'tab:orange', 'AC':'tab:green', 'OTH':'tab:grey'}
            labels = list(colors.keys())
            handles = [plt.Rectangle((0,0),1,1, color=colors[label]) for label in labels]  
            plt.bar(data_topic.Country[data_topic.division_eu=='EU14'], data_topic.total_costs[data_topic.division_eu=='EU14'],color=colors['EU14'])
            plt.bar(data_topic.Country[data_topic.division_eu=='EU13'], data_topic.total_costs[data_topic.division_eu=='EU13'],color=colors['EU13'])
            plt.bar(data_topic.Country[data_topic.division_eu=='AC'], data_topic.total_costs[data_topic.division_eu=='AC'],color=colors['AC'])
            plt.bar(data_topic.Country[data_topic.division_eu=='OTH'], data_topic.total_costs[data_topic.division_eu=='OTH'],color=colors['OTH'])
            plt.ticklabel_format(axis='Y', style = 'sci', useMathText=True)
            plt.title("Total costs: per group " + topic_name + year_name + " - funded projects")
            plt.legend(handles, labels)
            plt.savefig("total_costs_groups_"+topic_name+year_name+".png", dpi=300)
        ...
        if topic_name=="ALL":
            ...
            plt.legend(handles, labels)
            plt.savefig("total_costs_widening_all_calls.png", dpi=300)
        else:
            # use topic_name and year_name from the function arguments
            ...
            labels = list(colors.keys())
            handles = [plt.Rectangle((0,0),1,1, color=colors[label]) for label in labels]  
            plt.bar(data_topic.Country[data_topic.division_wd=='WD'], data_topic.total_costs[data_topic.division_wd=='WD'],color=colors['WD'])
            plt.ticklabel_format(axis='Y', style = 'sci', useMathText=True)
            plt.title("Total costs: widening " + topic_name + year_name + " - funded projects")
            plt.legend(handles, labels)
            plt.savefig("total_costs_widening_"+topic_name+year_name+".png", dpi=300)
...
def participation_count(topic_name, year_name, group_type):
    ...
    if group_type == "coordination":
        if topic_name=="ALL":
            ...
            plt.legend(handles, labels)
            plt.savefig("participation_count_all_calls.png", dpi=300)
        else:
            ...
            plt.legend(handles, labels)
            plt.savefig("participation_count_"+topic_name+year_name+".png", dpi=300)
        ...
        if topic_name=="ALL":
            ...
            plt.legend(handles, labels)
            plt.savefig("participation_count_EU14_all_calls.png", dpi=300)
        else:
            # use topic_name and year_name from the function arguments (both assigned before the first if statement)
            ...
            plt.legend(handles, labels)
            plt.savefig("participation_count_EU14_"+topic_name+year_name+".png", dpi=300)
        ...
        if topic_name=="ALL":
            ...
            plt.legend(handles, labels)
            plt.savefig("participation_count_EU13_all_calls.png", dpi=300)
        else:
            # use topic_name and year_name from the function arguments (both assigned before the first if statement)
            ...
            plt.legend(handles, labels)
            plt.savefig("participation_count_EU13_"+topic_name+year_name+".png", dpi=300)
        ...
        if topic_name=="ALL":
            ...
            plt.legend(handles, labels)
            plt.savefig("participation_count_AC_all_calls.png", dpi=300)
        else:
            # use topic_name and year_name from the function arguments (both assigned before the first if statement)
            ...
            plt.legend(handles, labels)
            plt.savefig("participation_count_AC_"+topic_name+year_name+".png", dpi=300)
        ...
        if topic_name=="ALL":
            ...
            plt.legend(handles, labels)
            plt.savefig("participation_count_WD_all_calls.png", dpi=300)
        else:
            # use topic_name and year_name from the function arguments (both assigned before the first if statement)
            ...
            plt.legend(handles, labels)
            plt.savefig("participation_count_WD_"+topic_name+year_name+".png", dpi=300)
        ...
        if topic_name=="ALL":            
            ...
            plt.legend(handles, labels)
            plt.savefig("participation_count_groups_all_calls.png", dpi=300)
        else:
            # use topic_name and year_name from the function arguments
            ...
            labels = list(colors.keys())
            handles = [plt.Rectangle((0,0),1,1, color=colors[label]) for label in labels]  
            plt.bar(data_topic.Country[data_topic.division_eu=='EU14'], data_topic.total_num[data_topic.division_eu=='EU14'],color=colors['EU14'])
            plt.bar(data_topic.Country[data_topic.division_eu=='EU13'], data_topic.total_num[data_topic.division_eu=='EU13'],color=colors['EU13'])
            plt.bar(data_topic.Country[data_topic.division_eu=='AC'], data_topic.total_num[data_topic.division_eu=='AC'],color=colors['AC'])
            plt.bar(data_topic.Country[data_topic.division_eu=='OTH'], data_topic.total_num[data_topic.division_eu=='OTH'],color=colors['OTH'])
            plt.title("Participation count: per group " + topic_name + year_name + " - funded projects")
            plt.legend(handles, labels)
            plt.savefig("participation_count_groups_"+topic_name+year_name+".png", dpi=300)
        ...
        if topic_name=="ALL":
            ...
            plt.legend(handles, labels)
            plt.savefig("participation_count_widening_all_calls.png", dpi=300)
        else:
            # use topic_name and year_name from the function arguments
            ...
            labels = list(colors.keys())
            handles = [plt.Rectangle((0,0),1,1, color=colors[label]) for label in labels]  
            plt.bar(data_topic.Country[data_topic.division_wd=='WD'], data_topic.total_num[data_topic.division_wd=='WD'],color=colors['WD'])
            plt.title("Participation count: widening " + topic_name + year_name + " - funded projects")
            plt.legend(handles, labels)
            plt.savefig("participation_count_widening_"+topic_name+year_name+".png", dpi=300)
...
### ------------ FUNCTION LEGAL TYPE ------------------------------------------
def legal_type(topic_name, year_name, group_type):
    ...
    plt.savefig("legal_type_all_calls.png", dpi=300)
    ...
    if group_type == "coordination":
        ...
        if topic_name=="ALL":
            ...
            labels = list(colors.keys())
            handles = [plt.Rectangle((0,0),1,1, color=colors[label]) for label in labels]  
            plt.bar(data_topic.legal_type, data_topic.legal_type_count,color=colors['WD'])
...
def country_groups(topic_name, year_name, group_type):
...
def success_rate(topic_name, year_name, group_type):
    ...
    if group_type == "groups_with_avg":
        if topic_name=="ALL":
            ...
            plt.savefig("country_success_rate_all_calls.png", bbox_inches='tight', dpi=300)
        else:
            # use topic_name and year_name from the function arguments
            ...
            plt.savefig("country_success_rate_" + topic_name + str(year_name) + ".png", bbox_inches='tight', dpi=300)
        ...
        if topic_name=="ALL":
            ...
            plt.savefig("country_success_rate_number_proposals_all_calls.png", bbox_inches='tight', dpi=300)
        else:
            # use topic_name and year_name from the function arguments
            sql_main = """ SELECT * FROM Annex7T7_new WHERE Status="Main list" AND Topic LIKE """+ '"'+ topic_name + str(year_name) + """-SPACE%" """
            list_main = pd.read_sql(sql_main,conn)
            ...
            plt.savefig("country_success_rate_number_proposals_" + topic_name + str(year_name) + ".png", bbox_inches='tight', dpi=300)
        ...
        if topic_name=="ALL":
            ...
            plt.savefig("country_success_rate_EU14_all_calls.png", bbox_inches='tight', dpi=300)
        else:
            sql_main = """ SELECT * FROM Annex7T7_new WHERE Status="Main list" AND Topic LIKE """+ '"'+ topic_name + str(year_name) + """-SPACE%" """
            list_main = pd.read_sql(sql_main,conn)
            sql_all = """ SELECT * FROM Annex7T7_new WHERE Status!="Ineligible" AND Topic LIKE """+ '"'+ topic_name + str(year_name) + """-SPACE%" """
            ...
            plt.savefig("country_success_rate_EU14_" + topic_name + str(year_name) + ".png", bbox_inches='tight', dpi=300)
        ...
        if topic_name=="ALL":
            ...
            plt.savefig("country_success_rate_EU13_all_calls.png", bbox_inches='tight', dpi=300)
        else:
            sql_main = """ SELECT * FROM Annex7T7_new WHERE Status="Main list" AND Topic LIKE """+ '"'+ topic_name + str(year_name) + """-SPACE%" """
            list_main = pd.read_sql(sql_main,conn)
            sql_all = """ SELECT * FROM Annex7T7_new WHERE Status!="Ineligible" AND Topic LIKE """+ '"'+ topic_name + str(year_name) + """-SPACE%" """
            ...
            plt.savefig("country_success_rate_EU13_" + topic_name + str(year_name) + ".png", bbox_inches='tight', dpi=300)
        ...
        if topic_name=="ALL":
            ...
            plt.savefig("country_success_rate_AC_all_calls.png", bbox_inches='tight', dpi=300)
        else:
            sql_main = """ SELECT * FROM Annex7T7_new WHERE Status="Main list" AND Topic LIKE """+ '"'+ topic_name + str(year_name) + """-SPACE%" """
            list_main = pd.read_sql(sql_main,conn)
            sql_all = """ SELECT * FROM Annex7T7_new WHERE Status!="Ineligible" AND Topic LIKE """+ '"'+ topic_name + str(year_name) + """-SPACE%" """
            ...
            plt.savefig("country_success_rate_AC_" + topic_name + str(year_name) + ".png", bbox_inches='tight', dpi=300)
        ...
        if topic_name=="ALL":
            ...
            plt.savefig("country_success_rate_WD_all_calls.png", bbox_inches='tight', dpi=300)
        else:
            sql_main = """ SELECT * FROM Annex7T7_new WHERE Status="Main list" AND Topic LIKE """+ '"'+ topic_name + str(year_name) + """-SPACE%" """
            list_main = pd.read_sql(sql_main,conn)
            sql_all = """ SELECT * FROM Annex7T7_new WHERE Status!="Ineligible" AND Topic LIKE """+ '"'+ topic_name + str(year_name) + """-SPACE%" """
            ...
            plt.savefig("country_success_rate_WD_" + topic_name + str(year_name) + ".png", bbox_inches='tight', dpi=300)
...
# --------------------------- Total Costs -------------------------------------
# arguments (in order): 
# topic_name (ALL, HORIZON-CL4-, HORIZON-EUSPA-), year_name (ALL, 2021, 2022), group_type(coordination, division_eu, widening)
...
# =============================================================================
# group="widening"
# total_costs("ALL","ALL",group)
# total_costs("HORIZON-CL4-","2021",group)
# total_costs("HORIZON-CL4-","2022",group)
# total_costs("HORIZON-EUSPA-","2021",group)
...
# =============================================================================
# group="coordination_EU14"
# participation_count("ALL","ALL",group)
# participation_count("HORIZON-CL4-","2021",group)
# participation_count("HORIZON-CL4-","2022",group)
# participation_count("HORIZON-EUSPA-","2021",group)
...
# =============================================================================
# group="pie"
# legal_type("ALL","ALL",group)
# legal_type("HORIZON-CL4-","2021",group)
# legal_type("HORIZON-CL4-","2022",group)
# legal_type("HORIZON-EUSPA-","2021",group)
...
# topic_name (ALL, HORIZON-CL4-, HORIZON-EUSPA-), year_name (ALL, 2021, 2022), group_type
# =============================================================================
# group="type_of_action"
# country_groups("ALL","ALL",group)
# country_groups("HORIZON-CL4-","2021",group)
# country_groups("HORIZON-CL4-","2022",group)
# country_groups("HORIZON-EUSPA-","2021",group)
...
# topic_name (ALL, HORIZON-CL4-, HORIZON-EUSPA-), year_name (ALL, 2021, 2022), group_type
# =============================================================================
# group="groups_with_avg_number_proposals_WD"
# success_rate("ALL","ALL",group)
# success_rate("HORIZON-CL4-","2021",group)
# success_rate("HORIZON-CL4-","2022",group)
# success_rate("HORIZON-EUSPA-","2021",group)
